...
# --------- UI ---------
st.title("🏦 ONE-TO-ONE Bank")
st.markdown('<p class="big-font">Your Secure Digital Banking Partner</p>', unsafe_allow_html=True)

tabs = st.tabs(["🏠 Home", "➕ Create Account", "💰 Deposit", "💸 Withdraw", "🔍 Check Account", "✏️ Update Account", "🗑️ Delete Account"])

# --------- Home Tab ---------
with tabs[0]:
    st.image("https://cdn.pixabay.com/photo/2017/07/23/07/52/bank-2531251_1280.jpg", use_column_width=True)
